...
let reginaMathers = {
  ...
  goals: [
    ...
    {name: "Find out what happened to Harry Flinders", desc: "You are curious about the way the brilliant young archaeologist died, all those years ago."},
    {name: "Learn more about the murder", desc: "Although it probably doesn't matter much to you, you are still curious as to how this could have happened to Abu Nazir, and can't wait to rub it in to Sir William if it is his fault."},
...
let chrisKovacs = {
  ...
  relations: [
    {name: "Professor Regina Mathers", person: "", desc: "The leader of your dig team.  You are rather scared of her temper, and treat her with great respect, as she could fire you on a whim." },
